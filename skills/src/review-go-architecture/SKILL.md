...
In scope:
- handler/usecase/entity responsibility boundaries
- domain knowledge placement and anti-corruption boundaries
- semantically correct service method calls
- YAGNI, SRP, defensive code, reuse, and shared filtering logic
...
```text
あなたは /review-go-architecture コマンドの1名のレビュー担当です。レビューのみ行い、ファイルは編集しないでください。
